...
public class SwissephException extends RuntimeException implements java.io.Serializable {
	...
	/**
	 * Default error code, if no other code had been specified. Its current
	 * value is '0'.
	 */
	...
	/**
	 * Error code, when the file could not be found. Its current value is
	 * FILE_ERROR + 8.
	 * 
	 * @see #FILE_ERROR
	 */
	...
	/**
	 * Error code, when the file could not be opened. Its current value is
	 * FILE_ERROR + 16.
	 * 
	 * @see #FILE_ERROR
	 */
	...
	/**
	 * Error code, when the file could not be read. Its current value is
	 * FILE_ERROR + 32.
	 * 
	 * @see #FILE_ERROR
	 */
	 ...
	 * that the content is not what it is expected to be. Its current value is
	 * FILE_ERROR + 64.
	 * 
	 * @see #FILE_ERROR
	 */
	...
	/**
	 * Error code, when the file is not a valid data file. Its current value is
	 * FILE_ERROR + 128.
	 * 
	 * @see #FILE_ERROR
	 */
	...
	/**
	 * Error code, when the object is not supported or unknown. Its current
	 * value is PARAM_ERROR + 4096.
	 * 
	 * @see #PARAM_ERROR
	 */
	public static final int UNSUPPORTED_OBJECT = PARAM_ERROR | 4096;
	/**
	 * Error code, when the parameter combination is invalid. Its current value
	 * is PARAM_ERROR + 8192.
	 * 
	 * @see #PARAM_ERROR
	 */
	...
	/**
	 * Error code, when the date is invalid Its current value is PARAM_ERROR +
	 * 16384.
	 * 
	 * @see #PARAM_ERROR
	 */
	...
	// User requested:
	/**
	 * Error code, when a user requested limit has been reached. Its current
	 * value is 262144.
	 */
	public static final int USER_ERROR = 256 * 1024;
	/**
	 * Error code, when a user requested time limit has been reached. Its
	 * current value is 524288.
	 * 
	 * @see #USER_ERROR
	 */
	...
	/**
	 * Returns the julian day number as ET of the current process. May return
	 * <i>Infinity</i>, if no date is available.
	 */
	public double getJD() {
		return jdet;
	}
	...
	/**
	 * Returns the return code from the underlying original C-source code, which
	 * is SweConst.ERR normally. You should not need to know this.
	 * 
