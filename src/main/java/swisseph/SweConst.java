...
/**
 * This class contains all the constants that might be interesting to the user
 * of the swisseph package.
 * <P>
 ...
 * @version 1.0.0a
 */
public class SweConst implements java.io.Serializable {
	 ...
	 * a real planet, but the ecliptic and nutation of that date. Its value is
	 * -1.
	 */
	...
	/**
	 * The number of the Hamburger or Uranian "planet" cupido. It is equal to
	 * 40.
	 */
	...
	/**
	 * The number of the Hamburger or Uranian "planet" kronos. It is equal to
	 * 43.
	 */
	public static final int SE_KRONOS = 43;
	/**
	 * The number of the Hamburger or Uranian "planet" appollon. It is equal to
	 * 44.
	 */
	public static final int SE_APOLLON = 44;
	/**
	 * The number of the Hamburger or Uranian "planet" admetos. It is equal to
	 * 45.
	 */
	public static final int SE_ADMETOS = 45;
	/**
	 * The number of the Hamburger or Uranian "planet" vulkanus. It is equal to
	 * 46.
	 */
	public static final int SE_VULKANUS = 46;
	/**
	 * The number of the Hamburger or Uranian "planet" poseidon. It is equal to
	 * 47.
	 */
	...
	/**
	 * The "planet" number of the fictitious body neptune-leverrier. It is equal
	 * to 51.
	 */
	public static final int SE_NEPTUNE_LEVERRIER = 51;
	/**
	 * The "planet" number of the fictitious body neptune-adams. It is equal to
	 * 52.
	 */
	public static final int SE_NEPTUNE_ADAMS = 52;
	/**
	 * The "planet" number of the fictitious body pluto-lowell. It is equal to
	 * 53.
	 */
	public static final int SE_PLUTO_LOWELL = 53;
	/**
	 * The "planet" number of the fictitious body pluto-pickering. It is equal
	 * to 54.
	 */
	...
	/**
	 * The "planet" number of the fictitious body &quot;Proserpina&quot;. It is
	 * equal to 57.
	 */
	public static final int SE_PROSERPINA = 57;
	/**
	 * The "planet" number of the fictitious body &quot;Waldemath&quot;. It is
	 * equal to 58.
	 */
	...
	/**
	 * This is a constant to access the ascendant value in parameter ascmc[] of
	 * SwissEph.swe_houses_armc() / SwissEph.swe_houses() or to specify the
	 * ascendant object in transit calculations. Its value is 0.
	 */
	public static final int SE_ASC = 0;
	/**
	 * This is a constant to access the medium coeli value in parameter ascmc[]
	 * of SwissEph.swe_houses_armc() / SwissEph.swe_houses() or to specify the
	 * medium coeli object in transit calculations. Its value is 1.
	 */
	public static final int SE_MC = 1;
	/**
	 * This is a constant to access the value of the sidereal time in parameter
	 * ascmc[] of SwissEph.swe_houses_armc() / SwissEph.swe_houses() or to
	 * specify the sidereal time as an object in transit calculations. Its value
	 * is 2.
	 */
	public static final int SE_ARMC = 2;
	/**
	 * This is a constant to access the vertex value in parameter ascmc[] of
	 * SwissEph.swe_houses_armc() / SwissEph.swe_houses() or to specify the
	 * vertex object in transit calculations. Its value is 3.
	 */
	public static final int SE_VERTEX = 3;
	/**
	 * This is a constant to access the value of the &quot;equatorial
	 * ascendant&quot; in parameter ascmc[] of SwissEph.swe_houses_armc() /
	 * SwissEph.swe_houses() or to specify the equatorial ascendant object in
	 * transit calculations. Its value is 4.
	 */
	 ...
	 * or to specify the corresponding object in transit calculations. Its value
	 * is 7.
	 */
	 ...
	 * is 8 now, meaning, ascmc[0] to ascmc[7] contain meaningful data, even
	 * though ascmc[] has to be of size 10.
	 */
	...
	/*
	 * flag bits for parameter iflag in function swe_calc() The flag bits are
	 * defined in such a way that iflag = 0 delivers what one usually wants: -
	 * the default ephemeris (SWISS EPHEMERIS) is used, - apparent geocentric
	 * positions referring to the true equinox of date are returned. If not only
	 * coordinates, but also speed values are required, use flag = SEFLG_SPEED.
	 *
	 * The 'L' behind the number indicates that 32-bit integers (Long) are used.
	 */
	/**
	 * Calculate the heliocentric position of the planet. This is a constant to
	 * be used as a flag to swe_calc() / swe_fixstar().
	 */
	 ...
	 */
	public static final int SEFLG_TRUEPOS = 16; // return true positions, not
												// apparent
	/**
	 * Calculate the position of the planet without considering the precession,
	 * i.e., calculate J2000 equinox. This is a constant to be used as a flag to
	 * swe_calc() / swe_fixstar().
	 */
	public static final int SEFLG_J2000 = 32; // no precession, i.e. give J2000
												// equinox
	/**
	 * Calculate the position of the planet without considering the nutation,
	 * i.e., calculate the mean equinox of the day. This is a constant to be
	 * used as a flag to swe_calc() / swe_fixstar().
	 */
	public static final int SEFLG_NONUT = 64; // no nutation, i.e. mean equinox
												// of date
	/**
	 * Calculate the speed of the planet. This calculation should not be used,
	 * as it is slower and less precise than SEFLG_SPEED. This is a constant to
	 * be used as a flag to swe_calc() / swe_fixstar().
	 * 
	 * @see #SEFLG_SPEED
	 */
	public static final int SEFLG_SPEED3 = 128; // speed from 3 positions (do
												// not use
	// it, SEFLG_SPEED is faster and more
	// precise.)
	/**
	 * Calculate the speed of the planet. This is a constant to be used as a
	 * flag to swe_calc() / swe_fixstar().
	 */
	public static final int SEFLG_SPEED = 256; // high precision speed
	/**
	 * Calculate the position of the planet without considering gravitational
	 * deflection. This is a constant to be used as a flag to swe_calc() /
	 * swe_fixstar().
	 */
	public static final int SEFLG_NOGDEFL = 512; // turn off gravitational
													// deflection
	/**
	 * Calculate the position of the planet without considering the 'annual'
	 * aberration of light. This is a constant to be used as a flag to
	 * swe_calc() / swe_fixstar().
	 */
	public static final int SEFLG_NOABERR = 1024; // turn off 'annual'
													// aberration of light
	/**
	 * Calculate the position of the planet in the earth equator coordinate
	 * system. This is a constant to be used as a flag to swe_calc() /
	 * swe_fixstar().
	 */
	public static final int SEFLG_EQUATORIAL = 2 * 1024; // equatorial positions
															// are wanted
	/**
	 * Return cartesian coordinates instead of polar coordinates. This is a
	 * constant to be used as a flag to swe_calc() / swe_fixstar().
	 */
	public static final int SEFLG_XYZ = 4 * 1024; // cartesian, not polar,
													// coordinates
	/**
	 * Return coordinates in radians instead of degrees. This is a constant to
	 * be used as a flag to swe_calc() / swe_fixstar().
	 */
	public static final int SEFLG_RADIANS = 8 * 1024; // coordinates in radians,
														// not degrees
	/**
	 * Calculate barycentric positions. This is a constant to be used as a flag
	 * to swe_calc() / swe_fixstar().
	 */
	public static final int SEFLG_BARYCTR = 16 * 1024; // barycentric positions
	/**
	 * Calculate topocentric positions. This is a constant to be used as a flag
	 * to swe_calc() / swe_fixstar().
	 */
	 ...
	 * constant to be used as a flag to swe_calc() / swe_fixstar().
	 */
	public static final int SEFLG_ICRS = 128 * 1024; // ICRS (DE406 reference
														// frame)
	public static final int SEFLG_DPSIDEPS_1980 = (256
			* 1024); /*
						 * reproduce JPL Horizons 1962 - today to 0.002 arcsec.
						 */
	public static final int SEFLG_JPLHOR = SEFLG_DPSIDEPS_1980;
	public static final int SEFLG_JPLHOR_APPROX = (512
			* 1024); /* approximate JPL Horizons 1962 - today */
	...
	/**
	 * calculate transits over a (longitudinal, latitudinal or distance) speed
	 * value. This is a constant to be used as a flag the TransitCalculator
	 * constructors.
	 * 
	 * @see swisseph.TCPlanet#TCPlanet(SwissEph, int, int, double)
	 * @see swisseph.TCPlanetPlanet#TCPlanetPlanet(SwissEph, int, int,
	 ...
	 * have an identically integer degree value in their respective sign == 30
	 * degree section: (int)(lon1 % 30) == (int)(lon2 % 30). This is a flag to
	 * the TransitCalculator constructors.
	 * 
	 * @see swisseph.TCPlanetPlanet#TCPlanetPlanet(SwissEph, int, int,
	 *      int, double)
	 */
	 ...
	 * aren't partile anymore. So they don't have an identically integer degree
	 * value in their respective sign == 30 degree section: (int)(lon1 % 30) !=
	 * (int)(lon2 % 30). This is a flag to the TransitCalculator constructors.
	 * 
	 * @see swisseph.TCPlanetPlanet#TCPlanetPlanet(SwissEph, int, int,
	 *      int, double)
	 */
	 ...
	 * <A HREF="ftp://navigator.jpl.nasa.gov/pub/ephem/export"> ftp://navigator.
	 * jpl.nasa.gov/pub/ephem/export</A> (as of December 21, 2000).
	 * 
	 ...
	 * Basically, these routines are identical to the JPL routines, but the data
	 * files are <I>much</I> more compressed (about one 10th of the original JPL
	 * files), and the exactness is retained to 1/1000 of an arc second.
	 * 
	 * @see SwissEph#swe_set_ephe_path(java.lang.String)
	 */
	 ...
	 * for the moon. Unfortunately, the deviation for true lunar nodes may be up
	 * to one arc minute.
	 */
	...
	/**
	 * This specifies that sidereal calculations are done via a projection onto
	 * the ecliptic at date t0.
	 * 
	 * @see SwissEph#swe_set_sid_mode(int, double, double)
	 */
	 ...
	 * Fagan/Bradley is used as default, if nothing other is specified via
	 * swe_set_sid_mode.
	 * 
	 * @see SwissEph#swe_set_sid_mode(int, double, double)
	 */
	...
	/**
	 * A constant to be used for specifying the sidereal mode (ayanamsha) as
	 * SURYASIDDHANTA (Suryasiddhanta, assuming ingress of mean Sun into Aries
	 * at point of mean equinox of date on 21.3.499, noon, Ujjain (75.7684565 E)
	 * = 7:30:31.57 UT).
	 * 
	 * @see SwissEph#swe_set_sid_mode(int, double, double)
	 */
	...
	/**
	 * A constant to be used for specifying the sidereal mode (ayanamsha) as
	 * SURYASIDDHANTA_MSUN (Suryasiddhanta, assuming ingress of mean Sun into
	 * Aries at true position of mean Sun at same epoch).
	 * 
	 * @see SwissEph#swe_set_sid_mode(int, double, double)
	 */
	...
	/**
	 * A constant to be used for specifying the sidereal mode (ayanamsha) as
	 * ARYABHATA (Aryabhata, same date as SE_SIDM_SURYASIDDHANTA_MSUN, but UT
	 * 6:56:55.57).
	 * 
	 * @see SwissEph#swe_set_sid_mode(int, double, double)
	 */
	...
	/**
	 * A constant to be used for specifying the sidereal mode (ayanamsha) as
	 * defined by the user in the additional two parameters of
	 * swe_set_sid_mode().
	 * 
	 * @see SwissEph#swe_set_sid_mode(int, double, double)
	 */
	 ...
	 */
	public static final int SE_NODBIT_OSCU_BAR = 4; // same, but motion about
													// solar
													// system barycenter is
													// considered
	/**
	...
	public static final int SE_HELFLAG_AVKIND = SE_HELFLAG_AVKIND_VR | SE_HELFLAG_AVKIND_PTO | SE_HELFLAG_AVKIND_MIN7
	...
	public static final int SE_HELIACAL_AVKIND = (SE_HELFLAG_AVKIND_VR | SE_HELFLAG_AVKIND_PTO | SE_HELFLAG_AVKIND_MIN7
			| SE_HELFLAG_AVKIND_MIN9);
	...
	public static final double SE_TIDAL_DE403 = (-25.580); /*
															 ...
															 * V. 1.76.2
															 */
	public static final double SE_TIDAL_DE404 = (-25.580); /*
															 * was (-25.8) until
															 * V. 1.76.2
															 */
	public static final double SE_TIDAL_DE405 = (-25.826); /*
															 * was (-25.7376)
															 * until V. 1.76.2
															 */
	public static final double SE_TIDAL_DE406 = (-25.826); /*
															 * was (-25.7376)
															 * until V. 1.76.2
															 */
	public static final double SE_TIDAL_DE421 = (-25.85); /*
															 * JPL Interoffice
															 * Memorandum
															 * 14-mar-2008 on
															 * DE421 Lunar Orbit
															 */
	public static final double SE_TIDAL_DE430 = (-25.82); /*
															 * JPL Interoffice
															 * Memorandum
															 * 9-jul-2013 on
															 * DE430 Lunar Orbit
	...
	/*
	 * former implementations of the used IAU 1976, 2000 and 2006 for a limited
	 * time range in combination with a different model for long term
	 * precession. #define SEMOD_PREC_DEFAULT_SHORT SEMOD_PREC_IAU_2000
	 */
	public static final int SEMOD_PREC_DEFAULT_SHORT = SEMOD_PREC_VONDRAK_2011;

	/* nutation models */
	public static final int SEMOD_NUT_IAU_1980 = 1;
	public static final int SEMOD_NUT_IAU_CORR_1987 = 2; /*
															 * Herring's (1987)
															 * corrections to
															 * IAU 1980 nutation
															 * series. AA (1996)
	...
	public static final int SEMOD_NUT_IAU_2000B = 4; /*
														 * fast, but precision of
														 * milli-arcsec
														 */
	public static final int SEMOD_NUT_DEFAULT = SEMOD_NUT_IAU_2000B; /*
																		 * fast,
																		 * but
																		 * precision
																		 * of
	...
	/* frame bias methods */
	public static final int SEMOD_BIAS_IAU2000 = 1; /*
													 * use frame bias matrix IAU
													 * 2000
													 */
	public static final int SEMOD_BIAS_IAU2006 = 2; /*
													 * use frame bias matrix IAU
													 * 2000
													 */
	 ...
	 */
	public static final int SEMOD_JPLHOR_EXTENDED_1800 = 1; /*
															 * daily dpsi and
															 * deps from file
															 * are limited to
															 * 1962 - today. JPL
															 ...
															 * range.
															 */
	public static final int SEMOD_JPLHOR_NOT_EXTENDED = 2; /*
															 * outside the
															 * available time
															 * range 1962 -
															 * today default to
	 ...
	 * ephemeris, but does not make sense otherwise. Before 1800, even this
	 * option does not provide agreement with Horizons, because Horizons uses a
	 * different precession model (Owen 1986) before 1800, which is not included
	 * in the Swiss Ephemeris. SEMOD_JPLHOR_NOT_EXTENDED causes the program to
	 * default to SEFLG_JPLHOR_APPROX, if the date is outside the time range
	 * 1962 - today, where values for dpsi and deps are given. Note that this
	 * will result in a non-continuous ephemeris near 20-jan-1962 and current
	 * years.
	 */

	/*
	 * methods of approximation of JPL Horizons (iflag & SEFLG_JPLHORA), without
	 * dpsi, deps; see explanations below
	 */
	 ...
	 * correction to RA and another correction is added to epsilon. This
	 * provides a very good approximation of JPL Horizons positions. With
	 * SEMOD_JPLHORA_2, frame bias as r$ecommended by IERS Conventions 2003 and
	 * 2010 is *not* applied. Instead, dpsi_bias and deps_bias are added to
	 * nutation. This procedure is found in some older astronomical software.
	 * Equatorial apparent positions will be close to JPL Horizons (within a few
	 * mas) beetween 1962 and current years. Ecl. longitude will be good,
	 * latitude bad.
	 */
	...
	/*
	 * ephemeris path this defines where ephemeris files are expected if the
	 * function swe_set_ephe_path() is not called by the application. Normally,
	 * every application should make this call to define its own place for the
	 * ephemeris files.
	 */
	/**
	 * Ephemeris path.
	 ...
	 * @see SwissEph#swe_set_ephe_path(java.lang.String)
	 */
	// ifndef SE_EPHE_PATH -- This is not currently possible to be done with
	// this environment
	public static final String SE_EPHE_PATH = ".:./ephe:/users/ephe2/:/users/ephe/";
	/*
	 * At Astrodienst, we maintain two ephemeris areas for the thousands of
	 * asteroid files: the short files in /users/ephe/ast*, the long file in
	 * /users/ephe2/ast*.
	 */
	// endif /* SE_EPHE_PATH */
	...
	/**
	 * The name of the file containing the orbital elements of ficticious
	 * planets.
	 */
	...
	/**
	 * Annular eclipse. This is an eclipse, where the moon is seen smaller than
	 * the sun, so you get a "ring" of the sun around the moon.
	 */
	...
	public static final int SE_ECL_ALLTYPES_SOLAR = SE_ECL_CENTRAL | SE_ECL_NONCENTRAL | SE_ECL_TOTAL | SE_ECL_ANNULAR
	...
	/**
	 * Begin of partial eclipse. This is the time, when the moon touches the sun
	 * the first time.
	 */
	...
	public static final int SE_ECL_PARTBEG_VISIBLE = 512; /*
															 ...
															 */
	/**
	 * Begin of total eclipse. This is the time, when the sun completely
	 * disappears.
	 */
	...
	public static final int SE_ECL_TOTBEG_VISIBLE = 1024; /*
															 ...
															 */
	/**
	 * End of total eclipse. This is the time, when the sun starts to reappear.
	 */
	...
	public static final int SE_ECL_TOTEND_VISIBLE = 2048; /*
															 ...
															 */
	/**
	 * End of partial eclipse. This is the time, when the moon and the sun
	 * finally separate.
	 */
	...
	public static final int SE_ECL_OCC_END_DAYLIGHT = 16384; /*
																 ...
																 */
	/**
	 * Just check if the next conjunction of the moon with a planet is an
	...
	/**
	 * Calculate the time of the upper meridian transit (southern for northern
	 * geo. latitudes). This is a constant to be used as a flag to
	 * swe_rise_trans().
	 */
	 ...
	 * 
	 * @see swisseph.SwissEph#swe_rise_trans(double, int,
	 *      java.lang.StringBuffer, int, int, double[], double, double,
	 *      swisseph.DblObj, java.lang.StringBuffer)
	 */
	...
	/*
	 * to be or'ed to SE_CALC_RISE/SET, if refraction is not to be considered
	 */
	...
	public static final int SE_BIT_ASTRO_TWILIGHT = 4096; /*
															 ...
															 * SE_CALC_RISE/SET
															 */
	public static final int SE_BIT_FIXED_DISC_SIZE = (16
			* 1024); /*
						 * or'ed to SE_CALC_RISE/SET: neglect the effect of
	 ...
	 * 
	 * @see swisseph.SwissEph#swe_azalt(double, int, double[], double,
	 ...
	 * 
	 * @see swisseph.SwissEph#swe_azalt_rev(double, int, double[],
	 *      double[], double[])
	 */
	...
	/* for swe_refrac() */
	/**
	 * Calculate the apparent altitude from the true altitude. This is a
	 * constant to be used as a flag to swe_refrac().
	 * 
	...
	/**
	 * Calculate the true altitude from the apparent altitude. This is a
	 * constant to be used as a flag to swe_refrac().
	 * 
	 * @see #SE_TRUE_TO_APP
	 * @see swisseph.SwissEph#swe_refrac(double, double, double, int)
	...
	// SwephData.SEI_NEPTUNE, SwephData.SEI_PLUTO, 0, 0, 0, 0,
	// SwephData.SEI_EARTH,
	...
	/**
	 * All variables are static, so there is no sense in instantiating this
	 * class.
	 */
	private SweConst() {
	}
