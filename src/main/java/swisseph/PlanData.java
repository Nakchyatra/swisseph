...
class PlanData implements java.io.Serializable {
	double x[] = new double[6]; /*
								 * position and speed vectors equatorial J2000
								 */
	double xreturn[] = new double[24]; /*
										 * return positions: xreturn+0 ecliptic
										 * polar coordinates xreturn+6 ecliptic
										 * cartesian coordinates xreturn+12
										 * equatorial polar coordinates
										 * xreturn+18 equatorial cartesian
										 * coordinates
										 */

	/*
	 * the following data are read from file only once, immediately after file
	 * has been opened
	 */
	...
	int iflg = 0; /*
					 ...
					 * coordinate system of orbital plane SEI_FLG_ELLIPSE: TRUE
					 * if reference ellipse
					 */
	int ncoe = 0; /*
					 * # of coefficients of ephemeris polynomial, is polynomial
					 * order + 1
					 */
	...
	double segp[] = null; /*
							 * pointer to unpacked cheby coeffs of segment; the
							 * size is 3 x ncoe
							 */
	int neval = 0; /*
					 * how many coefficients to evaluate. this may be less than
					 * ncoe
					 */
