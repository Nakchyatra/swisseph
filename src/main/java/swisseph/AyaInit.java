...
/**
 * A class to contain all the data for different ayanamsas.
 * <P>
 * t0 is the epoch at which ayanamsha = 0. For internal use only - the data is
 * packed into an array[21] of AyaInit. The available Ayanamshas are:<BR>
 * <UL>
 ...
 * <LI>19: J1900
 * <LI>20: B1950
 * <LI>21: Suryasiddhanta, assuming ingress of mean Sun into Aries at point of
 * mean equinox of date on 21.3.499, noon, Ujjain (75.7684565 E) = 7:30:31.57 UT
 * <LI>22: Suryasiddhanta, assuming ingress of mean Sun into Aries at true
 ...
 * @version 1.0.0a
 */
class AyaInit implements java.io.Serializable {
	double t0;
	double ayan_t0;
