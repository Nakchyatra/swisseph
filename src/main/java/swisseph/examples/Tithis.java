...
public class Tithis {
	...
	static final String[] tithi_names = { "Prathama", "Dwitiya", "Tritiya", "Chaturthi", "Panchami", "Shashti",
			"Saptami", "Ashtami", "Navami", "Dasami", "Ekadasi", "Dvadasi", "Trayodasi", "Chaturdashi", "Purnima", };
	...
	public static void main(String[] p) {
		...
		TransitCalculator tc = new TCPlanetPlanet(sw, SweConst.SE_MOON, SweConst.SE_SUN, flags, tithi_deg);
